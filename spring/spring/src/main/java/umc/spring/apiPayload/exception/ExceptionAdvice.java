...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleExceptionInternalConstraint(Exception e, ErrorStatus errorStatus,
        ...
        ApiResponse<Object> body = ApiResponse
                .onFailure(errorStatus.getCode(), errorStatus.getMessage(), null);
        ...
        e.getBindingResult().getFieldErrors().stream()
                .forEach(fieldError -> {
                    ...
                    errors.merge(fieldName, errorMessage,
                            (existingMessage, newErrorMessage) -> existingMessage + ", " + newErrorMessage);
                });
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(Exception e, HttpHeaders headers,
        ...
        ApiResponse<Map<String, String>> body = ApiResponse
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(Exception e, ErrorStatus errorStatus,
        ...
        ApiResponse<String> body = ApiResponse
